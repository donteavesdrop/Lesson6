package ru.mirea.zakharova.notebook;
...
import ru.mirea.zakharova.notebook.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void writeFileToExternalStorage() {
        ...
        File file = new File(path, binding.getname.getText().toString());
        try {
            FileOutputStream fileOutputStream = new FileOutputStream(file.getAbsoluteFile());
            OutputStreamWriter output = new OutputStreamWriter(fileOutputStream);
// Запись строки в файл
            output.write(binding.getcitata.getText().toString());
    ...
    public void readFileFromExternalStorage() {
        ...
        try {
            ...
            for (int i = 0; i < lines.stream().count(); i++){
                binding.citata.setText(binding.getcitata.getText().toString() + lines.get(i).toString());
            }
        } catch (Exception e) {
